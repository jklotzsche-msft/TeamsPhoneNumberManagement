...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\TeamsPhoneNumberManagement\functions", "$global:testroot\..\TeamsPhoneNumberManagement\internal\functions"),
	
	[string]
	$ModuleName = "TeamsPhoneNumberManagement",
...
$CommandPath = @(
    "$global:testroot\..\TeamsPhoneNumberManagement\functions"
    "$global:testroot\..\TeamsPhoneNumberManagement\internal\functions"
)
