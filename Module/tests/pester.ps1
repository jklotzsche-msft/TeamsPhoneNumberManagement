...
Remove-Module TeamsPhoneNumberManagement -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\TeamsPhoneNumberManagement\TeamsPhoneNumberManagement.psd1"
Import-Module "$PSScriptRoot\..\TeamsPhoneNumberManagement\TeamsPhoneNumberManagement.psm1" -Force
